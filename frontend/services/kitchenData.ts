...
export const MODULE_CATALOG: ModuleCatalogEntry[] = [
  ...
  {
    type: "gabinete_bajo_dos_cajones",
    category: "lower",
    label: "Gabinete Bajo de 2 Cajones",
    description: "Mueble bajo con dos cajones para almacenaje",
    icon: "🗄️",
    defaultDimensions: { height: 90, width: 40, depth: 60 },
    defaultOptions: { drawers: 2, doors: 0, shelves: 0, doorStyle: "Sin puerta", drawerSystem: "Soft-close" },
    configurableFields: ["height", "width", "depth", "drawers", "drawerSystem", "hasToeKick", "toeKickHeight", "hardwareFinish", "boardMaterial", "color"],
  },
  {
    type: "cajon_hueco_superior",
    category: "lower",
    label: "Cajón con Hueco Superior",
    description: "Mueble bajo dividido a la mitad: un cajón abajo y un hueco totalmente abierto arriba, sin puerta ni repisa",
    icon: "🗂️",
    defaultDimensions: { height: 90, width: 40, depth: 60 },
    defaultOptions: { drawers: 1, doors: 0, shelves: 0, drawerSystem: "Soft-close" },
    configurableFields: ["height", "width", "depth", "includesCountertop", "countertopMaterial", "hardwareFinish", "boardMaterial", "color"],
  },
  {
    type: "cajonera",
    category: "lower",
  ...
  },
  {
    ...
    category: "lower",
    label: "Gabinete Bajo de 2 Puertas",
    description: "Mueble bajo estándar con dos puertas y un estante interior",
    icon: "🗃️",
    defaultDimensions: { height: 90, width: 90, depth: 60 },
